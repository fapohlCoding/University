...
public class RootFileSystem {
    ...
    private void setupRoot(File rootFile) {
        if(rootFile != null && rootFile.exists()) { 		// The java.io.File.exists() method tests the existence 
            this.rootFile = rootFile;						// of the file or directory defined by this abstract pathname.
